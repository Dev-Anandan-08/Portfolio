      ...
      <footer className="bg-gray-900 py-5">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <a href="https://github.com/Dev-Anandan-08" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">GitHub</a>
              <a href="https://www.instagram.com/dear._.dev02/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">Instagram</a>
